...
<p><span style="color:#2563EB"><strong>LangGraph 工作流</strong></span> · <span style="color:#059669"><strong>多源可观测性</strong></span> · <span style="color:#7C3AED"><strong>混合 RAG</strong></span> · <span style="color:#DC2626"><strong>人工审核</strong></span></p>
...
> [!TIP]
> 英文术语不熟悉时先看 **[📘 常见英文速查](#english-terms)**; 第一次系统阅读建议从 **🧭 学习路线** 开始。
...
- 🗂️ [02 项目目录和模块关系](#chapter-02)
- 🔄 [03 一次请求的完整生命周期](#chapter-03)

### 🧠 核心调查机制

- 🧠 [04 IncidentState 与 Reducer](#chapter-04)
- 🕸️ [05 Graph、Node、Edge 与调查循环](#chapter-05)
...
- ⏸️ [10 Checkpoint、Streaming 与 Human-in-the-loop](#chapter-10)
...
需要直接读代码时, 建议先打开[源码解析版](INCIDENT_COPILOT_SOURCE_CODE_GUIDE.md)理解定义和依赖；熟悉项目后再使用[完整源码阅读索引](#core-reading-index)快速跳转。
...
> **➡️ 下一步:** [IncidentState 详细解释](#chapter-04)。
...
> **➡️ 下一步:** [Graph、Node 与调查循环](#chapter-05)。
...
> **➡️ 下一步:** [Provider、Tool 和 Evidence](#chapter-06)。
...
> **➡️ 下一步:** [FastAPI 与异步任务](#chapter-09)。
...
> **➡️ 下一步:** [Checkpoint、Streaming 与 HITL](#chapter-10)。
...
## ⏸️ 10 Checkpoint、Streaming 与 Human-in-the-loop
...
> **➡️ 下一步:** [Evaluation 与测试](#chapter-11)。
...
返回[完整源码阅读索引](#core-reading-index)或[学习中心](#learning-home)。
...
下一篇：[任务、Repository 与 Fixture](#walkthrough-16)。
...
下一篇：[RAG Schema 与向量存储](#walkthrough-19)。
...
下一篇：[Tool 契约与内置工具](#walkthrough-20)。
...
下一篇：[真实与 Fixture Provider](#walkthrough-21)。
...
下一篇：[Evaluation 辅助源码](#walkthrough-22)。
...
下一步：返回[完整源码阅读索引](#core-reading-index)，按模块选择真实源码对照阅读。
